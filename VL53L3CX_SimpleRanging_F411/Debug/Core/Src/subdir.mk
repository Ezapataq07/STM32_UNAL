...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/LiDAR_Main.d ./Core/Src/LiDAR_Main.o ./Core/Src/LiDAR_Main.su ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/vl53lx_platform.d ./Core/Src/vl53lx_platform.o ./Core/Src/vl53lx_platform.su ./Core/Src/vl53lx_platform_init.d ./Core/Src/vl53lx_platform_init.o ./Core/Src/vl53lx_platform_init.su ./Core/Src/vl53lx_platform_ipp.d ./Core/Src/vl53lx_platform_ipp.o ./Core/Src/vl53lx_platform_ipp.su ./Core/Src/vl53lx_platform_log.d ./Core/Src/vl53lx_platform_log.o ./Core/Src/vl53lx_platform_log.su
