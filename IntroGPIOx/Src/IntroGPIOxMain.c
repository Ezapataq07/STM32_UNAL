 ...
 * datos del micro (ambos son documentos diferentes y complementarios el uno con el otro)
 *
 ...
 * y salida de datos digitales (o sea 1's y y 0's), además se les puede asignar funciones
...
/* Función principal del programa. Es acá donde se ejecuta to do */
int main (void) {
