...
//	*pGPIOC_MODER_Reg	|= (0b10 << 16);	// Cargamos el valor 0b10 en los bits 16 y 17 -> Función alternativa
//	*GPIOC_OTYPER_Reg	&= ~(0x1UL << 8);	// Cargamos el valor 0 al bit 8 (salida tipo Push-Pull)
//	*GPIOx_OSPEEDR_Reg	|= (0b10 << 16);	// Cargamos el valor 0b10 en los bits 16 y 17 (Fast speed)
//	*GPIOC_AFRH_Reg		&= ~(0b1111 << 0);	// Cargamos el valor 0b0000 en los pimeros 4 bits.
